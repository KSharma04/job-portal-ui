        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <Link
                to="/contact"
                aria-label="Contact Us — reach out to our team for help or to report a problem"
              ...
              >
                ...
                <span
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-56 px-3 py-2 rounded-lg bg-gray-900 text-gray-100 text-xs font-medium text-center shadow-xl ring-1 ring-white/10 opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 group-focus-within:opacity-100 group-focus-within:translate-y-0 transition-all duration-300 z-20"
                >
                  Have a question or facing an issue? Reach out to our team and
                  we'll help you out.
